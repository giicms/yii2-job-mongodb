...
$this->title = 'Tạo một tài khoản nhân viên';
        ...
        <div class="container">
            <div class="row">
                <div class="title-container">
                    <h3 class="text-center">Tạo một tài khoản nhân viên</h3>
                    <p class="text-center">Bạn đang cần thuê nhân viên? <?= Html::a('Tạo một tài khoản boss', ['boss/register']) ?></p>
                </div>
                <!-- introduce item -->
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-register">
                        ...
                        <?= yii\authclient\widgets\AuthChoice::widget([
                             'baseAuthUrl' => ['site/registermember']
                        ]) ?>
                        ...
                        <?php
                        //echo $form->field($model, 'category', ['template' => '<div class="form-group"><div class="select">{input}</div>{hint}{error}</div>'])->dropDownList($model->categoryList, ['prompt' => 'Chọn danh mục'])->label(FALSE);
                        ?>

                        <!-- <div class="form-group">
                            <div class="select">
                                <select name="Membership[sector][]" class="form-control sector select2" multiple>
                                </select>
                            </div>
                        </div>   -->
                        <?php
    ...
    $(document).ready(function(){
        $(".pass-input").change(function(){
            ...
            if (str.test(data)) {
                ...
                $(this).focus();
                $(".alert-error-box").html("Mật khẩu không được viết tiếng việt");
            }
            else {

...
$this->title = 'Hãy chọn skill phù hợp với chuyên ngành của bạn!';
?>
<style>
    .disnone{
        display: none
                                            ...
                                            if (!empty($sectors)) {
                                                ...
                                                foreach ($sectors as $k => $val) {
                                                    ...
                                                    foreach ($val->skills as $skill) {
                                                        ...
                                                        if ($model->skills) {
                                                            if (in_array($skill, $model->skills)) {
                                                                $active = "active";
                                                                $item = "";
                                                            } else {
                                                                $active = "";
...
$(document).on("click", ".item", function () {
            ...
            if (count < 13){
                ...
                $.notify({
                    ...
                    message: "Bạn đã chọn tốt đa 12 kỷ năng cá nhân " 
                },{
                    // settings
                    type: "danger"
                });

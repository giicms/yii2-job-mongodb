                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-sm-7 col-xs-12 box-content-item">
                                    <div class="row">
                                        ...
                                        ?>
                                            <li><a href="<?=Yii::$app->urlManager->createAbsoluteUrl('huong-dan-su-dung/' . (string)$value->_id)?>"><?=$value->name?></a></li>
                                        <?php } ?> 
                                            </ul>  
                                        </div>
                                        <?php } ?>
                                        ...
                                        ?>
                                            <div class="col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <ul class="list-unstyled">
                                                    ...
                                                    ?>
                                                    <li><a href="<?=Yii::$app->urlManager->createAbsoluteUrl('huong-dan-su-dung/' . (string)$val->_id)?>"><?=$val->name?></a></li>
                                                    <?php        
                                                        }}   
                                                    ?>
                                                </ul>  

        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-4 col-xs-12">
                            <b>Các kỹ năng cần có</b>
                        </div>
                        <div class="col-md-9 col-sm-8 col-xs-12">
                            <p>
                                <?php
                                foreach ($job->skills as $value) {
                                    $skills[] = $job->getSkillname($value)['name'];
                                }
                                echo implode(',', $skills);
                                ?>
                            </p>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-4 col-xs-12">
                            <b>Thời gian kết thúc nhận việc</b>
                        </div>
                        <div class="col-md-9 col-sm-8 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="profile-item no-border">
                        ...
                        <div class="profile-content">
                            <ul class="list-unstyled">
                                <li><h5><a href="<?= Yii::$app->urlManager->createAbsoluteUrl('user/' . $bid->user->slug) ?>"><b><?= $bid->user->name ?></b></a><small> - Hoạt động cách đây <?= Yii::$app->convert->time($bid->user->created_at) ?></small></h5></li>
                                <li><b><?= $bid->user->findcategory->name ?></b></li>
                                <li>Cấp độ: <b><?= $bid->user->findlevel->name ?></b></li>
                                <li><i class="fa fa-map-marker"></i> <b><?= $bid->user->location->name . ', ' . $bid->user->location->city->name ?></b> - <small>Test năng lực: 6 - Portfolior: 5</small></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?= $form->field($assignment, 'terms')->checkbox() ?>

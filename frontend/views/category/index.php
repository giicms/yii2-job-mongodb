<?php
$this->title = 'Danh mục ngành nghề';
?>
<section>
            <!-- slide main -->
                    ...
                    ?>
                        ...
                        <div class="item">
                                <div class="info-member">
                                    <div class="avatar">
                                        <img class="img-circle" width="120" src="<?= Yii::$app->params['url_file'] ?>thumbnails/<?= !empty($value->avatar) ? '150-' . $value->avatar : "avatar.png" ?>">
                                    </div>
                                    <h4><a href="#"><?=$value->name?></a></h4>
                                    <div class="line-gray"></div>
                                    <h3><?=$value->findcategory->name;?></h3>
                                </div>
                                <div class="summary">
                                    <div class="col-6 rating">
                                        <span class="star text-blue">
                                            <?=$value->getStar($value->rating);?>
                                        </span>
                                        <span>(<?=$value->getPoint($value->_id)?>)</span>
                                    </div>  
                                    <div class="col-6 local">
                                        <i class="fa fa-map-marker"></i>
                                        <span><?php if(!empty($value->location->city->name)){echo $value->location->city->name;} ?></span>
                                    </div> 
                                ...
                                <div class="skill">
                                    ...
                                    if (!empty($value->skills)) {
                                        foreach ($value->skills as $k => $skill) {
                                            ...
                                            echo '<button class="button"  style="' . $dis . '; margin:0 2px;">' . $getskill['name'] . '</button>';
                                        }
                                    }
                                    ?>
                                </div>
                                <div class="bottom-inf">
                                    <p><?= Yii::$app->convert->excerpt($value->description, 100) ?></p>
                                    <a  href="<?= Yii::$app->urlManager->createAbsoluteUrl('user/' . $value->slug) ?>"><button class="btn btn-blue" type="button">Xem hồ sơ</button></a>
                                </div>
                        </div>
                        <!-- End member item -->
                    <?php }}?>

                        ...
                        foreach ($model as $key => $value) {
                            ...
                            <div class="profile-item user-<?= (string) $value->findactor->_id ?>">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="profile">
                                            <img width="150" src="<?= Yii::$app->params['url_file'] ?>thumbnails/<?= !empty($value->findactor->avatar) ? '150-' . $value->findactor->avatar : "avatar.png" ?>" class="avatar img-circle">
                                        ...
                                        <div class="profile-content text-left">
                                            <ul class="list-unstyled">
                                                ...
                                                <li>
                                                    ...
                                                    <b>Đà Nẵng, Việt Nam</b> - <small>Test năng lực: 6 - Portfolior: 5</small>
                                                </li>
                                                <li class="skill-pro">
                                                    <ul class="list-unstyled">
                                                        <?php

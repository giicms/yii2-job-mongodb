...
class ActionColumn extends \yii\grid\ActionColumn {
    ...
    protected function initDefaultButtons() {
        ...
        if (!isset($this->buttons['view']) && \Yii::$app->user->can('/' . $controller . '/view')) {
        ...
        if (!isset($this->buttons['update']) && \Yii::$app->user->can('/' . $controller . '/update')) {
        ...
        if (!isset($this->buttons['delete']) && \Yii::$app->user->can('/' . $controller . '/delete')) {

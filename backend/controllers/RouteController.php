...
class RouteController extends BackendController {
    ...
    public function actionIndex() {
        ...
        return $this->render('index', ['new' => $routes, 'exists' => $exists, 'existsOptions' => $existsOptions, 'route' => $manager->getPermissions()]);
    }
    ...
    public function actionAssign($action) {
        ...
        return [$this->actionRouteSearch('new'),
            $this->actionRouteSearch('exists'),
            $error];
    }

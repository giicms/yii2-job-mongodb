                ...
                <div class="x_title">
                    ...
                    echo Menu::widget([
                        'items' => [
                            ...
                            ['label' => 'Thêm mới', 'template' => '<a href="{url}" class="btn-success">{label}</a>', 'url' => [ 'create'], 'visible' => \Yii::$app->user->can('/post/create')]
                        ],
                    ...
                    GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function($data)
                                {
                                    if ($data->publish == Page::STATUS_ACTIVE)
                                        $check = 'checked';
                                    else
                                        $check = '';
...
<?= $this->registerJs('
    ...
    if (msg == true) {
     if(keys!=""){
      var url = "' . Yii::$app->urlManager->createUrl(["page/delete"]) . '";  

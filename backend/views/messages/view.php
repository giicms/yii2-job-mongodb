                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                ...
                                <div id="reportrange_right" class="pull-left" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; margin-bottom: 10px; margin-right: 10px">
                                    ...
                                    <input id="datefrom" value="<?= !empty($_GET['from']) ? $_GET['from'] : "" ?>" type="hidden" name="from">
                                    <input id="dateto" value="<?= !empty($_GET['to']) ? $_GET['to'] : "" ?>" type="hidden" name="to">
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <button type="submit" class="btn btn-success" style="margin-top:25px">Lọc</button> 
                                <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['messages/view', 'id' => $model->id]) ?>" class="btn btn-primary" style="margin-top:25px">Reset</a>
                            </div>
                        </div>
                    </form>
                    <?php
                    Pjax::begin([
                        'id' => 'pjax_gridview_conversation',
                    ])
                    ?>
                    <?=
                    GridView::widget([
...
<?= $this->registerJs('
   $(".btn_action_multiple").click(function () {
    var keys = $("#gridConversation").yiiGridView("getSelectedRows");

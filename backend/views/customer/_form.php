...
?> 
<?= $form->field($new, 'name')->textInput()->label('Tên khách hàng') ?>
<?= $form->field($new, 'description')->textInput()->label('Đơn vị') ?>
<?= $form->field($new, 'content')->textarea(['class' => 'form-control'])->label('Nhận xét khách hàng') ?>

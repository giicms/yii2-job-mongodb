...
?> 
<?= $form->field($model, 'name')->textInput()->label('Tên khách hàng') ?>
<?= $form->field($model, 'description')->textInput()->label('Đơn vị') ?>
<?= $form->field($model, 'content')->textarea(['class' => 'form-control'])->label('Nhận xét khách hàng') ?>

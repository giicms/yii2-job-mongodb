...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Số lượng tài khoản boss đăng ký trên hệ thống</h2>
    ...
    <div class="x_panel table-report">
        <div class="x_title">
            <h2>Danh sách boss trên hệ thống</h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content1">
                    ...
                    <div class="row">
                        <form method="get" accept-charset="utf-8">
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <label>Boss</label>
                                <select name="txt_bosstype" class="form-control select">
                                    <option value="1" <?php if(!empty($_GET['txt_bosstype'])){ if($_GET['txt_bosstype'] ==1) { echo 'selected="selected"';}}?>>Đã đăng ký</option>
                                    <option value="2" <?php if(!empty($_GET['txt_bosstype'])){ if($_GET['txt_bosstype'] ==2) { echo 'selected="selected"';}}?>>Đã bị khóa</option>
                                    <option value="3" <?php if(!empty($_GET['txt_bosstype'])){ if($_GET['txt_bosstype'] ==3) { echo 'selected="selected"';}}?>>Đăng việc nhiều nhất</option>
                                    <option value="4" <?php if(!empty($_GET['txt_bosstype'])){ if($_GET['txt_bosstype'] ==4) { echo 'selected="selected"';}}?>>Đánh giá nhiều nhất</option>
                                </select>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <label>Từ ngày</label>

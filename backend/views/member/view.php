                ...
                <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                        ...
                        <ul class="list-unstyled user_data">
                            ...
                            <li><i class="fa fa-briefcase user-profile-icon"></i> <?= !empty($model->categoty) ? $model->findcategory->name : "Chưa cập nhật" ?></li>
                            <li class="m-top-xs"><i class="fa fa-external-link user-profile-icon"></i> <?= !empty($model->sector) ? $model->findsector->name : "Chưa cập nhật" ?></li>
                        </ul>
